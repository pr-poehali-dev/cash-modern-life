...
const StorageSection = () => {
  return (
    <section id="money-storage" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="bank" className="max-w-4xl mx-auto">
          ...
          <TabsContent value="bank" className="p-6 bg-white rounded-lg shadow-sm">
            <h3 className="text-2xl font-bold text-primary-600 mb-4">Банковские вклады и счета</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <span className="text-green-500 font-bold mr-2">✓</span>
                    <span>Защита от кражи и потери</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <span className="text-primary-500 font-bold mr-2">•</span>
                    <span>Выбирайте вклады с возможностью пополнения и частичного снятия для гибкости</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <TabsContent value="invest" className="p-6 bg-white rounded-lg shadow-sm">
            <h3 className="text-2xl font-bold text-primary-600 mb-4">Инвестиционные инструменты</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-xl font-semibold mb-2">Преимущества</h4>
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <span className="text-green-500 font-bold mr-2">✓</span>
                    <span>Защита от инфляции в долгосрочной перспективе</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <span className="text-primary-500 font-bold mr-2">•</span>
                    <span>Начинайте с менее рискованных инструментов и постепенно расширяйте портфель</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <TabsContent value="cash" className="p-6 bg-white rounded-lg shadow-sm">
            <h3 className="text-2xl font-bold text-primary-600 mb-4">Хранение наличных дома</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-xl font-semibold mb-2">Преимущества</h4>
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <span className="text-green-500 font-bold mr-2">✓</span>
                    <span>Надежность во время технических сбоев или кризисов</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-primary-500 font-bold mr-2">•</span>
                    <span>Используйте надежные сейфы, встроенные в стену или вмонтированные в пол</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary-500 font-bold mr-2">•</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-primary-500 font-bold mr-2">•</span>
                    <span>Рассмотрите возможность хранения нескольких валют для диверсификации</span>
                  </li>
                </ul>
              </div>
            </div>
